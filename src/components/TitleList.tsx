      ...
      <div className="flex font-heading">
        {current > 0 && (
          <div className="relative">
            <div
              ...
              className="flex absolute items-center left-[-15px] top-[125px] text-[rgb(176,176,176)] text-6xl cursor-pointer hover:text-custom-white hover:scale-110 duration-300">
              <FaChevronLeft />
            </div>
          </div>
        )}
        ...
        <div className="relative">
          <div
            ...
            className="flex absolute items-center right-[-15px] top-[125px] text-[rgb(176,176,176)] text-6xl cursor-pointer hover:text-custom-white hover:scale-110 duration-300">
            <FaChevronRight />
          </div>
        </div>
      </div>
